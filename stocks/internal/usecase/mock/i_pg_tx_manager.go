...
import (
	"context"
	mm_usecase "stocks/internal/usecase"
	"sync"
...
type IPgTxManagerMock struct {
	...
	funcWithTx          func(ctx context.Context, fn func(mm_usecase.IStockRepo) error) (err error)
	funcWithTxOrigin    string
	inspectFuncWithTx   func(ctx context.Context, fn func(mm_usecase.IStockRepo) error)
...
type IPgTxManagerMockWithTxParams struct {
	ctx context.Context
	fn  func(mm_usecase.IStockRepo) error
}
...
func (mmWithTx *mIPgTxManagerMockWithTx) Expect(ctx context.Context, fn func(mm_usecase.IStockRepo) error) *mIPgTxManagerMockWithTx {
...
func (mmWithTx *mIPgTxManagerMockWithTx) ExpectFnParam2(fn func(mm_usecase.IStockRepo) error) *mIPgTxManagerMockWithTx {
	if mmWithTx.mock.funcWithTx != nil {
		mmWithTx.mock.t.Fatalf("IPgTxManagerMock.WithTx mock is already set by Set")
	}
...
func (mmWithTx *mIPgTxManagerMockWithTx) Inspect(f func(ctx context.Context, fn func(mm_usecase.IStockRepo) error)) *mIPgTxManagerMockWithTx {
...
func (mmWithTx *mIPgTxManagerMockWithTx) Set(f func(ctx context.Context, fn func(mm_usecase.IStockRepo) error) (err error)) *IPgTxManagerMock {
	if mmWithTx.defaultExpectation != nil {
...
// Then helper
func (mmWithTx *mIPgTxManagerMockWithTx) When(ctx context.Context, fn func(mm_usecase.IStockRepo) error) *IPgTxManagerMockWithTxExpectation {
	if mmWithTx.mock.funcWithTx != nil {
		mmWithTx.mock.t.Fatalf("IPgTxManagerMock.WithTx mock is already set by Set")
	}
...
func (mmWithTx *IPgTxManagerMock) WithTx(ctx context.Context, fn func(mm_usecase.IStockRepo) error) (err error) {
